...
def choose_intent_classifier(classifier_name: str, 
                             model_name: str = "gpt-3.5-turbo", 
                             classifier_type: str = 'few-shot', 
    ...
    if classifier_name == "GPT":
        ...
        return GPTIntentClassifier(model_name=model_name, classifier_type=classifier_type, train_ds_path=train_ds_path)
...
if __name__ == "__main__":
    ...
    classifier = choose_intent_classifier(classifier_name=classifier_name, model_name=model_name, classifier_type=classifier_name, train_ds_path=train_ds_path, tokenizer_name=tokenizer_name)
    print(classifier.model_name)
    print(classifier.openai_api_key)
